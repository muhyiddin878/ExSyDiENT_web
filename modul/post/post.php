<title>Post - ExSyDiENT</title>
<script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

<!-- <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script> -->
<!-- <script src="../aset/tinymce/jquery.tinymce.min.js"></script>
<script src="../aset/tinymce/tinymce.min.js"></script> -->
<!-- <script>tinymce.init({selector:'textarea#editor1'});</script> -->
...
$aksi1 = "modul/post/aksi_post.php";
$aksi2 = "../modul/post/aksi_post.php";
$aksi3 = "../../modul/post/aksi_post.php";
switch ($_GET[act]) {
    // Tampil post
    default:
        $offset = $_GET['offset'];
        ...
        echo "<form method=POST action='?module=post' name=text_form onsubmit='return Blank_TextField_Validator_Cari()'>
		  ...
		  <tr><td><input class='btn bg-olive margin' type=button name=tambah value='Add Post' onclick=\"window.location.href='post/tambahpost';\"><input type=text name='keyword' style='margin-left: 10px;' placeholder='Write and Click Search...' class='form-control' value='$_POST[keyword]' /> <input class='btn bg-olive margin' type=submit value='   Search   ' name=Go></td> </tr>
          </table></form>";
        ...
        if ($_POST[Go]) {
		  ...
		  <tbody>";
			 ...
			 <td align=center><a type='button' class='btn btn-success margin' href=post/editpost/$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubahx </a> &nbsp;
	          <a type='button' class='btn btn-danger margin' href=\"JavaScript: confirmIt('Are You Sure Want to Delete this Item?','$aksi1?module=post&act=hapus&id=$r[kode_post]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"> <i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
                    $no++;
                    $counter++;
                }
		  ...
		  ";
			 ...
			 <td>$r[srn_post]</td>
			 <td align=center>
			 <a type='button' class='btn btn-success margin' href=post/editpost/$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Edit </a> &nbsp;
	          <a type='button' class='btn btn-danger margin' href=\"JavaScript: confirmIt('Are You Sure Want to Delete this Item ?','$aksi1?module=post&act=hapus&id=$r[kode_post]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\">
    ...
    case "tambahpost":
     include "tinymce.php";
        echo "<form name=text_form method=POST action='$aksi2?module=post&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          <br><br><table class='table table-bordered'>
		  ...
		  <tr><td width=120>Detail Post</td><td> <textarea id='editor1'  rows='4' cols='50' class='form-control texteditor' name='det_post'type=text placeholder='Insert New Post Details...'></textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea id='editor2'  rows='4' cols='50' class='form-control texteditor' name='srn_post'type=text placeholder='Insert New Suggestion Post...'></textarea></td></tr>
		  ...
		  <input class='btn btn-danger' type=button name=batal value='Cancel' onclick=\"window.location.href='?module=post';\"></td></tr>
          </table></form>";
        break;
    ...
    include "tinymce.php";
        ...
        echo "<form name=text_form method=POST action='$aksi3?module=post&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Detail Post</td><td><textarea id='editor1a' rows='4' cols='50' type=text class='form-control' name='det_post'>$r[det_post]</textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea id='editor2a' rows='4' cols='50' type=text class='form-control' name='srn_post'>$r[srn_post]</textarea></td></tr>
