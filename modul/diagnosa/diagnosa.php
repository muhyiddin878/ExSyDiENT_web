<title>Diagnosa - ExSyDiENT</title>
<?php
switch ($_GET['act']) {
...
// --------------------- END -------------------------
	...
	<h2 class='text text-primary'>Diagnosis Results &nbsp;&nbsp;</h2>
	          <hr><table class='table table-bordered table-striped diagnosa'>

          <th width=10%>Code</th>
          <th>Symptoms Experienced (complaints)</th>
      ...
      echo "</table><div class='well well-small'><img class='card-img-top img-bordered-sm' style='float:right; margin-left:15px;' src='" . $gambar . "' height=200><h3>Diagnosis Result</h3>";
      echo "<div class='callout callout-default'>The type of Disease suffered is <b><h3 class='text text-success'>" . $nmpkt[1] . "</b> / " . round($vlpkt[1], 2) . " % (" . $vlpkt[1] . ")<br></h3>";
      echo "</div></div><div class='box box-info box-solid'><div class='box-header with-border'><h3 class='box-title'>Details</h3></div><div class='box-body'><h4>";
      echo $ardpkt[$idpkt[1]];
      echo "</h4></div></div>
          <div class='box box-warning box-solid'><div class='box-header with-border'><h3 class='box-title'>Suggestion</h3></div><div class='box-body'><h4>";
      echo $arspkt[$idpkt[1]];
      echo "</h4></div></div>
          <div class='box box-danger box-solid'><div class='box-header with-border'><h3 class='box-title'>Another Possibility:</h3></div><div class='box-body'><h4>";
      ...
      echo "
	 <h2 class='text text-primary'>Diagnosis of Disease</h2>  <hr>
	 <div class='alert alert-success alert-dismissible'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                <h4><i class='icon fa fa-exclamation-triangle'></i>Attention !</h4>
                Please choose the symptoms according to your condition, you can choose the certainty of your condition from definitely not until sure yes, if you already press the process button (<i class='fa fa-search-plus'></i>)  below to see results.
              </div>
		<form name=text_form method=POST action='diagnosa' >
           ...
           <tr><th>Code</th><th>Symptoms</th><th width='20%'>Choose Condition</th></tr>";
      ...
      while ($r3 = mysql_fetch_array($sql3)) {
        ...
        echo '<td class="opsi"><select name="kondisi[]" id="sl' . $i . '" class="opsikondisi"/><option data-id="0" value="0">Choose</option>';
