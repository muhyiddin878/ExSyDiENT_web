<title>Information - ExSyDiENT</title>
        ...
        <div class="card text-center">
          ...
          <div class="card-block">
            <h4 class="card-title"><h3 class="bg-keterangan"><?php echo $r['nama_post']; ?></h3>
              <a class="btn bg-maroon btn-flat margin" href="#" data-toggle="modal" data-target="#modal<?php echo $r['kode_post']; ?>"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Details</a>
              <a class="btn bg-olive btn-flat margin" href="#" data-toggle="modal" data-target="#modaltindakan<?php echo $r['kode_post']; ?>"><i class="fa fa-quote-right" aria-hidden="true"></i> Suggestion</a>
          </div>
        </div>
        <hr>
      </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header detail-ket">
              ...
              <h4 class="modal-title text text-ket"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Details For <?php echo $r[nama_post]; ?></h4>
            </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header saran-ket">
              <button type="button" class="close" data-dismiss="modal" style="opacity: .99;color: #fff;">&times;</button>
              <h4 class="modal-title text text-ket"><i class="fa fa-quote-right" aria-hidden="true"></i> Suggestion for <?php echo $r[nama_post]; ?></h4>
            </div>
            <div class="modal-body" style="text-align: justify;text-justify: inter-word;">
